...
//	char buffer[255];
//	sprintf(buffer, "gameId=%d&imei=%Ld&money=%d&corpse=%d&star=%d&playerName=%s", GameID, AppDelegate::s_imei, AppDelegate::s_Money, AppDelegate::s_KillMonster, star, name.c_str());
